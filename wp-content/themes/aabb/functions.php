...
function lista_inscritos_campeonatos(){
    add_menu_page('Inscritos nos Campeonatos', 'Inscritos nos campeonatos', 'read', 'inscritos-campeonatos', 'lista_inscritos');
...
function mostrarMembrosTimesCampeonato(){
    ...
    foreach ($r_membros as $membro) {
        ...
        $nome_jogador = explode(" ", $user->display_name);
        $nome_jogador = $nome_jogador[0];
        $jogadores[] = array(
...
//(math) função que gera a tabela sem iniciar o campeonato
...
add_action('wp_ajax_gerarTabela', 'gerarTabela');
