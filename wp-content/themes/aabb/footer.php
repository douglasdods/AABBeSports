...
<section id="contato">
	<div class="col-titulo-jogos">
        <h1 class="titulo-jogos">Contato</h1>
    </div>
    	...
    	<div class="col-md-9">
    		<div class="row">
		    	...
		    	<div class="col-md-6 footer-contact">
		    		<img src="<?php echo AABB_THEME_URI?>/img/Icons/icon-whats.png">
		    		<h3>Whatsapp: (33) 99854-5216</h3>
		    		<img src="<?php echo AABB_THEME_URI?>/img/Icons/Contato-branco.png">
		    		<h3>Email: esports@fenabb.org.br</h3>
