                                ...
                                <div class="lista-chaveamento">
                                    ...
                                    foreach ($results as $key) {
                                        ...
                                        <div class="fase">
                                            ...
                                            ?>
                                            <?php 
                                                if ($usuario_logado  &&  ($user_id == $time_1_capitao || $user_id == $time_2_capitao || $usuario_author) && $key['wo'] == 'Não' && ($key['resultado_status'] == 'Em Aberto' || ($key['resultado_status'] == 'Contestado' && ($usuario_author || $permissao_global))) && $acesso_wo &&  ($usuario_author || empty($key['data_encerramento']) || $now < strtotime($key['data_encerramento']) ) ) { ?>
                                                    <div class="times">
